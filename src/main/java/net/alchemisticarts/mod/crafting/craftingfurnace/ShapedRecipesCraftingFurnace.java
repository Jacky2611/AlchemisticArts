...
public class ShapedRecipesCraftingFurnace implements IRecipe
{
    ...
    public ShapedRecipesCraftingFurnace(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public ShapedRecipesCraftingFurnace func_92100_c()
    {
